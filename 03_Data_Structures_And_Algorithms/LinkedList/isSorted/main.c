...
//  int A[] = {10,20,30,40,50,90,600};
  int A[] = {10, 20, 30, 40};
  head = createLinkedList(A, 4);
  
  if( isSorted(head, INCREASING) )
        printf("The List in Increasing order sorted position\n"); 
  else if( isSorted(head, DECREASING) )
        printf("The List in Decreasing order sorted position\n"); 
  else
